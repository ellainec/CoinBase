...
var RequestNew = function (_Component) {
    ...
    function RequestNew() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = RequestNew.__proto__ || (0, _getPrototypeOf2.default)(RequestNew)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(event) {
                var campaign, _this$state, description, amount, recipient, accounts;
    ...
    (0, _createClass3.default)(RequestNew, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_Layout2.default, null, _react2.default.createElement(_routes.Link, { route: '/campaigns/' + this.props.address + '/requests' }, _react2.default.createElement('a', null, 'Back')), _react2.default.createElement('h3', null, ' Create a Request'), _react2.default.createElement(_semanticUiReact.Form, { onSubmit: this.onSubmit, error: !!this.state.errorMessage }, _react2.default.createElement(_semanticUiReact.Form.Input, { label: 'Description',
                value: this.state.description,
                onChange: function onChange(event) {
                    return _this3.setState({ description: event.target.value });
                }
            }), _react2.default.createElement(_semanticUiReact.Form.Input, { label: 'Amount in Ether',
                value: this.state.amount,
                onChange: function onChange(event) {
                    return _this3.setState({ amount: event.target.value });
                }
            }), _react2.default.createElement(_semanticUiReact.Form.Input, { label: 'Recipient',
                value: this.state.recipient,
                onChange: function onChange(event) {
                    return _this3.setState({ recipient: event.target.value });
                }
            }), _react2.default.createElement(_semanticUiReact.Button, { primary: true, content: 'Create', loading: this.state.loading }), _react2.default.createElement(_semanticUiReact.Message, { error: true, header: 'Oops!', content: this.state.errorMessage })));
        }
    }], [{
        key: 'getInitialProps',
        value: function () {
